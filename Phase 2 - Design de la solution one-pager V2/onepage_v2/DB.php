...
{
    try {
        $this->db = new PDO('mysql:host=localhost;dbname=preinscription', 'root', 'root'); //objet PDO contenant les infos de connection à la DB (nom DB, username et mot de passe)
